...
def run():
	...
	VarNameFixes.insert({"Incorrect Var Name": "hlat",   "CF Standard Name": "latitude",         "Known Fix": "lat"})
	VarNameFixes.insert({"Incorrect Var Name": "hlon",   "CF Standard Name": "longitude",        "Known Fix": "lon"})
